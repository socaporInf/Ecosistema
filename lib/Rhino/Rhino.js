  ...
  var Slot = function(registro){
		...
		var Celda = function(atributos){
			...
			this.construirNodo = function(){
				...
				nodo.classList.add(this.clases[this.atributos.celdas - 2]);
				this.nodo = nodo;
