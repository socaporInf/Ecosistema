//BUG: cuando se agrega un slot a la lista y es el unico no le coloca la clase "primero" por lo tanto este se esconde tras la barra de busqueda
...
var Cabecera = function(){
	...
	this.cambiarTexto = function(texto){
...
var Botonera = function(atributos){
	...
	this.construir = function(){
		...
		if(UI.elementos.maestro!=='noPosee'){
			...
			//boton buscar
			console.log(this.buscarBoton('buscar'));
