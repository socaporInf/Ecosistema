		...
		return new Promise(function(resolve, reject) {
			...
			.then(function(json){
				if(json.success===1){
					...
					sesionActiva.zafra = json.sesion.Zafra;
					var zafra = sesionActiva.zafra;
					zafra.nombre = zafra.nombre.substr(0,4)+"-"+zafra.nombre.substr(4);
					UI.elementos.cabecera.agregarHTML("<div class='titulo-der' id='cam_zafra' title='Presione aqui para cambiar de Zafra!' onclick='UI.elementos.cabecera.cambio_zafra()'>ZAFRA: "+zafra.nombre+"</div>");
